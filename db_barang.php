...
if (isset($_POST["action"])) {
    ...
    if ($_POST["action"] == "insert") {
        ...
        $sql ="insert into barang values('$id_mobil','$nomor_mobil','$jenis','$warna','$tahun_pembuatan','$biaya_sewa_per_hari','$filename')";
    ...
    elseif ($_POST["action"] == "update") {
        if (!empty($_FILES["image"]["name"])) {
           ...
           $hasil= mysqli_fetch_array($result);
             ...
             tahun_pembuatan='$tahun_pembuatan', biaya_sewa_per_hari='$biaya_sewa_per_hari where id_mobil='$id_mobil'";
            ...
            $sql="update mobil set nomer_mobil='$nomer_mobil', merk='$merk', jenis='$jenis',warna='$warna', tahun_pembuatan='$tahun_pembuatan', biaya_sewa_per_hari='$biaya_sewa_per_hari' where id_mobil='$id_mobil'";
    ...
    if (isset($_GET["hapus"])) {
        ...
        if (file_exists("image_mobil/".$hasil["image"])) {
         ...
         $sql = "delete from barang where id_mobil='$id_mobil'";
         if (mysqli_query($koneksi,$sql)) {
         $_SESSION["message"] = array(
         "type" => "success",
